...
class PurePursuit(object):
    ...
    def __init__(self):
        ...
        self.linear_x_acc = 0.0
        self.linear_y_acc = 0.0
    ...
    def imu_callback(self, Imu_msg):
        self.angular_v_x  = Imu_msg.angular_velocity.x 
        self.angular_v_y  = Imu_msg.angular_velocity.y 
        self.angular_v_z  = Imu_msg.angular_velocity.z 

        self.linear_x_acc = Imu_msg.linear_acceleration.x
        self.linear_y_acc = Imu_msg.linear_acceleration.y

        print("++++++++++++++***********")
        print(f'{self.angular_v_z}')
        print(f'{self.linear_x_acc}, {self.linear_y_acc}')
    ...
    def start_pp(self):
        ...
        while not rospy.is_shutdown():
            ...
            print(f"output_accel: {output_accel}")
            ...
            ## method2
            with open("/home/gem/demo_ws/src/vehicle_drivers/gem_gnss_control_/waypoints/ex5.csv","a") as csvfile:
                writer = csv.writer(csvfile)
                # writer.writerow(["index", "a_name", "b_name"])
                writer.writerows([[curr_x, curr_y, curr_yaw]])
