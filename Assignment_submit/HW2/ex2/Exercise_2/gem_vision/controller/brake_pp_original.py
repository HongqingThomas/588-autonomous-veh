...
class PurePursuit(object):
    ...
    def start_pp(self):
        ...
        while not rospy.is_shutdown():
            ...
            L           = round(middle_dist, 3) # 3 is the decimal places to round to
            alpha = self.heading_to_yaw(270.0) - curr_yaw
            ...
            # ## case 3 : from circle to straight lane (turn right)
            # if:
            ...
            # ## case 4 : straight East
            # ##---------- computed L----------##
            # # L = self.dist_arr[self.goal]
            # x_reference = 
            # z_reference = 
            # L           = round(np.sqrt(x_reference ** 2 + z_reference ** 2), 3)
            # alpha = self.heading_to_yaw(90.0) - curr_yaw
            ...
            # ## case 8 : from circle to straight lane (turn left)
            # if:
