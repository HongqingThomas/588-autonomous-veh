...
class ImageConverter:
    def __init__(self):
        ...
        if Real_car:
            ...
            sync = message_filters.ApproximateTimeSynchronizer([self.subcriber_rgb, self.depth_img_sub, self.subcriber_rgb_camera], 10, 0.1)
    ...
    def car_multi_callback(self, rgb, depth, camera_info):
        ...
        print("start time, prev time = ", start_time, self.prev_time)
        print("delay = ", start_time - self.prev_time)
